...
def run_server(processes=1, daemon='start'):
  ...
  print db_file
  TotoServer(method_module='web_methods', port=9000, debug=True, processes=processes, daemon=daemon, pidfile='server.pid', database='file', db_host=db_file, db_port=0, hmac_enabled=True, startup_function='web_startup.on_start').run()
